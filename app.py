...
# kerala bus
lists_k=[]
df_k=pd.read_csv("kerala_details.csv")
for i,r in df_k.iterrows():
    lists_k.append(r["Route_name"])

#Andhra bus
lists_A=[]
df_A=pd.read_csv("Andhra_details.csv")
for i,r in df_A.iterrows():
    lists_A.append(r["Route_name"])

#Telungana bus
lists_T=[]
df_T=pd.read_csv("Telangana_details.csv")
for i,r in df_T.iterrows():
    lists_T.append(r["Route_name"])

#Goa bus
lists_g=[]
df_G=pd.read_csv("J&K_details.csv")
for i,r in df_G.iterrows():
    lists_g.append(r["Route_name"])

#Rajastan bus
lists_R=[]
df_R=pd.read_csv("RAJASTHAN_details.csv")
...
# South bengal bus 
lists_SB=[]
df_SB=pd.read_csv("HIMACHAL_details.csv")
for i,r in df_SB.iterrows():
    lists_SB.append(r["Route_name"])

# Haryana bus
lists_H=[]
df_H=pd.read_csv("Bihar_details.csv")
for i,r in df_H.iterrows():
    lists_H.append(r["Route_name"])

#Assam bus
lists_AS=[]
df_AS=pd.read_csv("ASSAM_details.csv")
for i,r in df_AS.iterrows():
    lists_AS.append(r["Route_name"])

#UP bus
lists_UP=[]
df_UP=pd.read_csv("UP_details.csv")
for i,r in df_UP.iterrows():
    lists_UP.append(r["Route_name"])

#West bengal bus
lists_WB=[]
df_WB=pd.read_csv("WESTBENGAL_details.csv")
...
web=option_menu(menu_title="🚌OnlineBus",
                options=["Routes and their info"],
                icons=["house","info-circle"],
                orientation="horizontal"
                )

# States and Routes page setting
if web == "Routes and their info":
    S = slt.selectbox("Lists of States", ["Kerala", "Adhra Pradesh", "Telangana", "Himachal", "Rajastan", 
                                          "Jammu", "Bihar", "Assam", "Uttar Pradesh", "West Bengal"])
    ...
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            conn = mysql.connector.connect(host="localhost", user="root", password="Divya@1996", database="REDBUS")
